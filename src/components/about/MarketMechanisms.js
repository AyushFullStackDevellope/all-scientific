...
const cardsData = [
  { image: "/assets/images/about/transparent.avif", text: "Transparent Workflow Systems" },
{ image: "/assets/images/about/ISO-img.avif", text: "ISO 9001:2016 (Future)" },
{ image: "/assets/images/about/investor-img.avif", text: "Investor Relations" },
    ...
    <div>
      <div className="governance-wrapper">
        ...
        <div className="governance-banner">
          <img src={"/assets/images/about/MarketMechanisms-img.avif"} alt="Governance" />
        </div>
        {/* {/ Cards Section /} */}
