  ...
  return (
    <div className="utilizecore-container">
      ...
      <div className="utilizecore-left">
        <img src={"/assets/images/UtilizeCore-Logo-Blue.svg"} alt="UtilizeCore Logo" className="logo" />
        <p>
      ...
      <div className="utilizecore-right">
        <img src={ "/assets/images/screen-mode.avif"} alt="UtilizeCore Flow" className="flow-image" />
